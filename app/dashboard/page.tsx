...
export default function DashboardPage() {
  return (
    <div className="flex flex-col gap-4">
      <DashboardHeader heading="Dashboard" text="Overview of your profile and analytics." />
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4">
          <CardHeader>
            ...
            <CardDescription>View and link click analytics for the past 30 days.</CardDescription>
          </CardHeader>
